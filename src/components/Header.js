...
export default class MmpMmp extends Component {
    constructor(props){
        ...
        show(o,i){
         ...
         ggg(data){
         console.log("ggg")
               // let ty={type:"uss",zh:this.state.zh,pas:this.state.pas};
             ...
             <div style={styles.div2}>
                 ...
                 <ul style={styles.ul} className="uls">
                   ...
                   <li style={styles.li}>产品管理</li>
                     ...
                     <ul style={styles.ul} className="uls">
                         <li style={styles.li}>折线图统计</li>
                         <li style={styles.li}>柱状图统计</li>
                         <li style={styles.li}>饼状图统计</li>
                     </ul>
                 </div>
             </div>
          </div>
...
const styles={
    ...
    head:{width:"180px",minHeight:"800px",background:"#eeeeee",position: "absolute",left:"0",top:"40px",display:"flex",flexDirection:"column"},
    ...
    div2:{width:"100%",height:"40px",background:"#eeeeee",position:"relative"},
